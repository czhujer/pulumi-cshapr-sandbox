...
class MyStack : Stack
{
    public MyStack()
    {
        ...
        var resourceGroupTest = new ResourceGroup("Main", new()
        {
            ResourceGroupName = "patrik-majer-playground-rg",
        });

        var userAssignedIdentityTest = new AzureNative.ManagedIdentity.UserAssignedIdentity("userAssignedIdentity", new()
        {
            ResourceGroupName = resourceGroupTest.Name,
            ResourceName = "myIdentity-1",
            
        });

        // Create an Azure Resource Group
        var resourceGroup = new ResourceGroup("patrik-majer-playground-aks-rg");
